...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .row.justify-content-center.mb-5
      .col-lg-2.col-7.mb-lg-0.mb-3: img(src='@/assets/curso/temas/s1.svg', alt='')
      .col-lg-10
        p.mb-0 Este componente aborda los fundamentos y técnicas primordiales para la configuración, implementación y gestión de redes inalámbricas, así como los dispositivos de cómputo que las soportan. Comienza con un análisis de las tecnologías inalámbricas y sus estándares principales, como Wi-Fi, Bluetooth, y redes celulares 3G/4G/5G, que también explora conceptos de propagación en el espectro electromagnético y arquitecturas que sustentan estas redes.
    .row.justify-content-center.mb-5
      .col-lg-9.mb-lg-0.mb-3
        p.mb-0 Asimismo, se examinan los dispositivos que permiten el intercambio de datos de manera inteligente y eficiente en la red, considerando no solo los componentes básicos, sino también aquellos que habilitan funcionalidades avanzadas, como la integración de sensores y controladores. Esta interconectividad resulta fundamental en el contexto del Internet de las Cosas (IoT), donde los dispositivos deben operar en conjunto para lograr una red funcional, autónoma y escalable, capaz de sostener múltiples usuarios y aplicaciones.
          br
          br
