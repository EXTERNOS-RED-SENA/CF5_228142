  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.f2
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Infraestructura inalámbrica
    ...
    .row.justify-content-center.mb-5.g-0
      .col-lg-6.mb-lg-0.mb-3
        .tarjeta.p-4.h-100(style="background-color: #c6e9f3 ")
          .row.mb-4
            .col-2: img(src='@/assets/curso/temas/27.svg', alt='')
          p.mb-0 Las antenas son otro pilar fundamental en la infraestructura inalámbrica, ya que determinan la calidad y el alcance de la señal. La elección de la antena adecuada —omnidireccional o direccional— depende del entorno y los objetivos de cobertura. Las antenas omnidireccionales, que emiten señales en todas direcciones, son ideales para cubrir áreas circulares o pequeñas, mientras que las antenas direccionales enfocan la señal hacia una zona específica, maximizando el alcance en esa dirección. La correcta instalación y orientación de las antenas es fundamental para evitar zonas muertas (dead zones) y lograr una cobertura uniforme.
      .col-lg-6.mb-lg-0.mb-3
        .tarjeta.p-4.h-100(style="background-color: #f3f0ea ")
          .row.mb-4
            .col-2: img(src='@/assets/curso/temas/28.svg', alt='')
          p.mb-0 Para diseñar redes inalámbricas eficientes, es necesario realizar estudios de cobertura conocidos como site surveys, que permiten identificar los mejores puntos para colocar los APs y las antenas. Estas evaluaciones consideran factores físicos del entorno, como paredes, techos, materiales de construcción y posibles interferencias. Realizar un site survey permite prever problemas y asegurarse de que la red ofrecerá la máxima cobertura posible, minimizando las áreas sin señal y evitando interferencias que puedan afectar el rendimiento de la red.
    div(style="background-color: #efe8f7 ")
      .row.justify-content-center.mb-5.g-0
        .col-lg-5.d-lg-block.d-none: img(src='@/assets/curso/temas/29.png', alt='')
        .col-lg-7
          .p-4
            p.mb-0 Adicionalmente a la cobertura, la gestión de interferencias es un aspecto primordial de la infraestructura inalámbrica. Las redes inalámbricas pueden verse afectadas por otros dispositivos electrónicos, especialmente en lugares donde existen múltiples redes que operan en frecuencias similares. A través de una planificación adecuada y el uso de canales no superpuestos, los administradores de red pueden minimizar la interferencia y optimizar el rendimiento de la red. La selección de frecuencias y el ajuste de la potencia de transmisión también son aspectos fundamentales que se deben ajustar para evitar solapamientos y mantener una conexión estable.
    ...
    .row.justify-content-center.mb-5
      .col-lg-3.col-6.mb-lg-0.mb-3: img(src='@/assets/curso/temas/31.png', alt='')
      .col-lg-9
    ...
    #t_3_2.titulo-segundo.color-acento-contenido(data-aos='fade-right')
      h2 3.2	Antenas y cobertura
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-2.col-7.mb-lg-0.mb-3: img(src='@/assets/curso/temas/32.svg', alt='')
      .col-lg-9
        p.mb-0 Las antenas son componentes vitales en las redes inalámbricas, ya que determinan tanto el alcance como la calidad de la señal en un área específica. Estas permiten que la señal inalámbrica se distribuya de forma efectiva, maximizando la cobertura y minimizando las áreas sin conexión, conocidas como zonas muertas (dead zones). Las antenas se seleccionan y configuran según las características del espacio físico y las necesidades de conectividad, considerando factores como la densidad de usuarios, la ubicación de los dispositivos y los obstáculos que puedan interferir con la señal.
    .row.justify-content-center.mb-5.g-0
      .col-lg-6.mb-lg-0.mb-3
        .tarjeta.p-4.h-100(style="background-color: #e0d4f0 ")
          p.mb-0 Existen varios tipos de antenas utilizadas en redes inalámbricas, cada una con características específicas. Las antenas omnidireccionales emiten la señal en todas direcciones, lo que las hace ideales para cubrir áreas amplias donde los dispositivos se mueven libremente, como oficinas abiertas o áreas públicas. En cambio, las antenas direccionales enfocan la señal en una dirección específica, proporcionando un alcance más largo y concentrado. Estas son útiles para áreas con rutas establecidas o para conectar edificios cercanos, ya que permiten un control más preciso sobre la dirección de la señal.

            
      .col-lg-6.mb-lg-0.mb-3
        .tarjeta.p-4.h-100(style="background-color: #c3d8c2 ")
    ...
    .row.justify-content-center.mb-5
      .col-lg-9.mb-lg-0.mb-3
        ...
        .cajon.color-secundario.p-4.mb-4
          .row.justify-content-center.align-items-center
            .col-lg-1.col-4.mb-lg-0.mb-3: img(src='@/assets/curso/temas/33.svg', alt='')
            .col-lg-11
